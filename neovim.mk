...
neovim: neovim-setup gettext lua-luv libuv1 msgpack libvterm libtermkey unibilium luajit
	...
	cd $(BUILD_WORK)/neovim/build && cmake . \
		...
		-DLIBLUV_LIBRARY="$(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/liblua5.1-luv.dylib" \
		-DLIBLUV_INCLUDE_DIR="$(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include/lua5.1/" \
		..
...
neovim-package: neovim-stage
	...
	$(GINSTALL) -Dm0755 $(BUILD_INFO)/neovim.$$i $(BUILD_DIST)/neovim/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec/neovim/$$i; \
	done
