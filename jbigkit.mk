...
jbigkit: jbigkit-setup
	...
	$(GINSTALL) -D -m644 $(BUILD_WORK)/jbigkit/libjbig/jbig.h $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include/jbig.h
	...
	$(GINSTALL) -D -m755 $(BUILD_WORK)/jbigkit/pbmtools/jbgtopbm85 $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/jbgtopbm85
	$(GINSTALL) -D -m755 $(BUILD_WORK)/jbigkit/pbmtools/pbmtojbg85 $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbmtojbg85

	$(GINSTALL) -d -m755 $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1
	$(GINSTALL) -m644 "$(BUILD_WORK)/jbigkit/pbmtools/pbmtojbg.1" $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1
	$(GINSTALL) -m644 "$(BUILD_WORK)/jbigkit/pbmtools/jbgtopbm.1" $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1
...
jbigkit-package: jbigkit-stage
	...
	mkdir -p \
			$(BUILD_DIST)/libjbig0/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib \
			$(BUILD_DIST)/libjbig-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib \
			$(BUILD_DIST)/jbigkit-bin/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,share/man/man1}

	# jbigkit.mk Prep libjbig0
	cp -a $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libjbig.0.dylib $(BUILD_DIST)/libjbig0/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib

	# jbigkit.mk Prep libjbig-dev
	cp -a $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include $(BUILD_DIST)/libjbig-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
	cp -a $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libjbig.dylib $(BUILD_DIST)/libjbig-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib

	# jbigkit.mk Prep jbigkit-bin
	cp -a $(BUILD_STAGE)/jbigkit/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,share} $(BUILD_DIST)/jbigkit-bin/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
