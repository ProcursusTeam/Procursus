...
x265-package: x265-stage
	...
	mkdir -p $(BUILD_DIST)/libx265-$(X265_SOVERSION)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib \
		$(BUILD_DIST)/libx265-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib \
		$(BUILD_DIST)/x265/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
	
	# x265.mk Prep libx265-$(X265_SOVERSION)
	cp -a $(BUILD_STAGE)/x265/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libx265.$(X265_SOVERSION).dylib $(BUILD_DIST)/libx265-$(X265_SOVERSION)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib

	# x265.mk Prep libx265-dev
	cp -a $(BUILD_STAGE)/x265/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/!(*.$(X265_SOVERSION)*) $(BUILD_DIST)/libx265-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib
	cp -a $(BUILD_STAGE)/x265/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include $(BUILD_DIST)/libx265-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)

	# x265.mk Prep x265
	cp -a $(BUILD_STAGE)/x265/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/x265 $(BUILD_DIST)/x265/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
