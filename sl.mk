...
sl-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/sl/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
...
sl: sl-setup ncurses
	$(CC) $(CFLAGS) -o $(BUILD_STAGE)/sl/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/sl $(BUILD_WORK)/sl/sl.c $(LDFLAGS) -lncursesw
...
sl-package: sl-stage
	...
	# sl.mk Prep sl
	cp -a $(BUILD_STAGE)/sl/$(MEMO_PREFIX)$(MEMO_SUBPREFIX) $(BUILD_DIST)/sl
