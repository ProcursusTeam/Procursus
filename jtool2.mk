...
jtool2-setup: setup
	...
	rm -rf $(BUILD_WORK)/jtool2-bin && mkdir -p $(BUILD_WORK)/jtool2-bin && pushd $(BUILD_WORK)/jtool2-bin && $(TAR) -C . -xf $(BUILD_SOURCE)/jtool2.tgz && popd
