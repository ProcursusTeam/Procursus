...
vi: vi-setup ncurses
	...
	+$(MAKE) -C $(BUILD_WORK)/vi install \
		...
		LIBEXECDIR=/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/ex \
...
vi-package: vi-stage
	...
	rm -rf $(BUILD_DIST)/vi
	mkdir -p $(BUILD_DIST)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,share/man/man1}
	
	# vi.mk Prep vi
	cp -a $(BUILD_STAGE)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/ex $(BUILD_DIST)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/ex-vi
	cp -a $(BUILD_STAGE)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib $(BUILD_DIST)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
	cp -a $(BUILD_STAGE)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1/ex.1 $(BUILD_DIST)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1/exa.1
	cp -a $(BUILD_STAGE)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1/vi.1 $(BUILD_DIST)/vi/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1/via.1
