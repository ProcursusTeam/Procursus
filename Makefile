...
BRIDGEOS_DEPLOYMENT_TARGET  := 26.0
...
bootstrap:: strapprojects
	...
	-if echo $(MEMO_TARGET) | grep "darwin"; then \
		PKGS="apt/apt_*.deb brotli/libbrotli1_*.deb cacerts/ca-certificates_*.deb coreutils/coreutils_*.deb darwintools/darwintools_*.deb dpkg/dpkg_*.deb gnupg/gpgv_*.deb apt/libapt-pkg7.0_*.deb libassuan/libassuan9_*.deb libffi/libffi8_*.deb libgcrypt/libgcrypt20_*.deb libgmp10/libgmp10_*.deb gnutls/libgnutls30_*.deb libgpg-error/libgpg-error0_*.deb nettle/libhogweed7_*.deb libidn2/libidn2-0_*.deb gettext/libintl8_*.deb lz4/liblz4-1_*.deb xz/liblzma5_*.deb libmd/libmd0_*.deb nettle/libnettle9_*.deb npth/libnpth0_*.deb p11-kit/libp11-kit0_*.deb openssl/libssl4_*.deb libtasn1/libtasn1-6_*.deb libunistring/libunistring5_*.deb xxhash/libxxhash0_*.deb zlib-ng/libz-ng2_*.deb zstd/libzstd1_*.deb keyring/procursus-keyring_*.deb tar/tar_*.deb"; \
	else \
		PKGS="apt/apt_*.deb base/base_*.deb bash/bash_*.deb brotli/libbrotli1_*.deb cacerts/ca-certificates_*.deb chariz-keyring/chariz-keyring_*.deb coreutils/coreutils_*.deb darwintools/darwintools_*.deb dash/dash_*.deb debianutils/debianutils_*.deb diffutils/diffutils_*.deb diskdev-cmds/diskdev-cmds_*.deb dpkg/dpkg_*.deb essential/essential_*.deb file-cmds/file-cmds_*.deb findutils/findutils_*.deb firmware-sbin/firmware-sbin_*.deb gnupg/gpgv_*.deb grep/grep_*.deb havoc-keyring/havoc-keyring_*.deb launchctl/launchctl_*.deb apt/libapt-pkg7.0_*.deb libassuan/libassuan0_*.deb libxcrypt/libcrypt2_*.deb dimentio/libdimentio0_*.deb libedit/libedit0_*.deb libffi/libffi8_*.deb libgcrypt/libgcrypt20_*.deb libgmp10/libgmp10_*.deb gnutls/libgnutls30_*.deb libgpg-error/libgpg-error0_*.deb nettle/libhogweed7_*.deb libidn2/libidn2-0_*.deb gettext/libintl8_*.deb libiosexec/libiosexec1_*.deb libkrw/libkrw0_*.deb lz4/liblz4-1_*.deb xz/liblzma5_*.deb libmd/libmd0_*.deb ncurses/libncursesw6_*.deb nettle/libnettle9_*.deb npth/libnpth0_*.deb p11-kit/libp11-kit0_*.deb pam-modules/libpam-modules_*.deb openpam/libpam2_*.deb pcre/libpcre1_*.deb pcre2/libpcre2-8-0_*.deb readline/libreadline8_*.deb libtasn1/libtasn1-6_*.deb libunistring/libunistring5_*.deb xxhash/libxxhash0_*.deb zlib-ng/libz-ng2_*.deb zstd/libzstd1_*.deb ncurses/ncurses-bin_*.deb ncurses/ncurses-term_*.deb openssh/openssh-server_*.deb openssh/openssh-sftp-server_*.deb openssh/openssh-client_*.deb openssl/libssl4_*.deb keyring/procursus-keyring_*.deb profile.d/profile.d_*.deb sed/sed_*.deb shell-cmds/shell-cmds_*.deb shshd/shshd_*.deb snaputil/snaputil_*.deb sudo/sudo_*.deb system-cmds/system-cmds_*.deb tar/tar_*.deb uikittools/uikittools_*.deb vi/vi_*.deb zsh/zsh_*.deb"; \
	fi; \
...
ifeq ($(shell grep -q 'rootless' <<< '$(MEMO_TARGET)' && echo 1),1)
	echo -e "Types: deb\n\
URIs: $(MEMO_REPO_URI)/\n\
Signed-by: $(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/keyrings/memo.gpg\n\
Suites: $(MEMO_CFVER)\n\
...
setup:
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/libsyscall/wrappers/{spawn/spawn{$(comma)_private}$(comma)libproc/libproc{$(comma)_internal$(comma)_private}}.h \
		...
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/{EXTERNAL_HEADERS/mach-o/nlist$(comma)osfmk/mach/vm_statistics}.h \
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach-o, \
		https://github.com/apple-oss-distributions/dyld/raw/dyld-1378/{include/mach-o/dyld_{process_info$(comma)introspection}$(comma)cache-builder/dyld_cache_format}.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/kern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/osfmk/kern/ledger.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/IOKit, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/iokit/IOKit/IOKitDebug.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/libkern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/libkern/libkern/OSKextLibPrivate.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/kern,https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/osfmk/kern/debug.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/arm, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/{bsd/arm/disklabel$(comma)osfmk/arm/cpu_capabilities}.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/machine, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/bsd/machine/disklabel.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/os, \
		...
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/libkern/os/{base_private$(comma)log_private$(comma)log}.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/CommonCrypto, \
		https://github.com/apple-oss-distributions/CommonCrypto/raw/CommonCrypto-600035/include/Private/CommonDigestSPI.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/bsm, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/bsd/bsm/audit_kevents.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/IOKit/kext, \
		https://github.com/apple-oss-distributions/IOKitUser/raw/IOKitUser-100231.120.3/kext.subproj/{KextManagerPriv$(comma)OSKext$(comma)OSKextPrivate$(comma)kextmanager_types$(comma){fat$(comma)macho$(comma)misc}_util}.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Security, \
		https://github.com/apple-oss-distributions/Security/raw/Security-61040.120.67/OSX/libsecurity_keychain/lib/SecKeychainPriv.h \
		https://github.com/apple-oss-distributions/Security/raw/Security-61040.120.67/OSX/libsecurity_codesigning/lib/Sec{CodeSigner$(comma){Code$(comma)Requirement}Priv}.h \
		https://github.com/apple-oss-distributions/Security/raw/Security-61040.120.67/base/SecBasePriv.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/machine, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/osfmk/machine/cpu_capabilities.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/firehose, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/libkern/firehose/{tracepoint$(comma)firehose_types}_private.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/libkern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6//libkern/libkern/{OSKextLibPrivate$(comma)mkext$(comma)prelink}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/osfmk/mach/coalition.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/firehose, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/libkern/firehose/tracepoint_private.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/libkern/firehose/firehose_types_private.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/bsd/sys/{fcntl$(comma)fsctl$(comma)spawn_internal$(comma)resource$(comma)event$(comma)kdebug$(comma)proc$(comma)proc_info$(comma)pgo$(comma)proc_uuid_policy$(comma)acct$(comma)stackshot$(comma)event$(comma)mbuf$(comma)kern_memorystatus$(comma)reason}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/dispatch, \
		https://github.com/apple-oss-distributions/libdispatch/raw/libdispatch-1542.0.4/private/{private$(comma)benchmark$(comma){apply$(comma)channel$(comma)data$(comma)introspection$(comma)io$(comma)layout$(comma)mach$(comma)queue$(comma)source$(comma)time$(comma)workloop}_private}.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/corecrypto, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/EXTERNAL_HEADERS/corecrypto/cc{$(comma)digest$(comma)n$(comma)_config$(comma)_impl$(comma)_error$(comma)sha1$(comma)sha2}.h)
...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-12377.121.6/bsd/sys/resource.h \
	...
	@if [ -d "$(MACOSX_SYSROOT)/usr/include/mach-o/i386" ]; then cp -af $(MACOSX_SYSROOT)/usr/include/mach-o/i386 $(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach-o; fi
	@cp -af $(MACOSX_SYSROOT)/usr/include/mach-o/{x86_64,arm} $(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach-o
