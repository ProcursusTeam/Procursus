...
setup:
	@mkdir -p \
		$(BUILD_BASE) $(BUILD_BASE)$(MEMO_PREFIX)/{{,System}/Library/Frameworks,$(MEMO_SUB_PREFIX)/{include/{bsm,objc,os/internal,sys,firehose,CoreFoundation,IOKit/kext,libkern,{mach/,}machine,CommonCrypto,Security},lib/pkgconfig,$(MEMO_ALT_PREFIX)/lib}} \
	...
	@wget -q -nc -P $(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys \
		https://opensource.apple.com/source/xnu/xnu-7195.101.1/bsd/sys/cdefs.h
