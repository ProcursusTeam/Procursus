...
ifneq ($(MEMO_TARGET),darwin-arm64e)
	...
	cd $(BUILD_STRAP) && rm -f !(apt_*|darwintools_*|dpkg_*|gpgv_*|libapt-pkg6.0_*|libgcrypt20_*|libgpg-error0_*|libintl8_*|liblz4-1_*|liblzma5_*|libxxhash0_*|libzstd1_*|procursus-keyring_*|tar_*|uikittools_*).deb
