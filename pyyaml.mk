...
pyyaml: pyyaml-setup libyaml
	...
	rm -rf $(BUILD_STAGE)/pyyaml/usr/lib/python$(PYTHON3_MAJOR_V)/site-packages/yaml/__pycache__
	mv $(BUILD_STAGE)/pyyaml/usr/lib/python$(PYTHON3_MAJOR_V)/site-packages/PyYAML-5.3.1-py$(PYTHON3_MAJOR_V).egg-info \
		$(BUILD_STAGE)/pyyaml/usr/lib/python$(PYTHON3_MAJOR_V)/site-packages/PyYAML-5.3.1.egg-info
...
pyyaml-package: pyyaml-stage
	...
	mkdir -p $(BUILD_DIST)/python3-yaml/usr/lib/python3/dist-packages
	
	# pyyaml.mk Prep python3-yaml
	cp -a $(BUILD_STAGE)/pyyaml/usr/lib/python$(PYTHON3_MAJOR_V)/site-packages/* $(BUILD_DIST)/python3-yaml/usr/lib/python3/dist-packages
