...
gitea: gitea-setup
	...
	$(GINSTALL) -Dm644 $(BUILD_WORK)/gitea/custom/conf/app.example.ini $(BUILD_STAGE)/gitea/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/gitea/example.ini
	$(SED) -i 's|@MEMO_PREFIX@|$(MEMO_PREFIX)|g' $(BUILD_STAGE)/gitea/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/gitea/example.ini
