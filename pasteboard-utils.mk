...
pasteboard-utils-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
...
pasteboard-utils: pasteboard-utils-setup 
	$(CC) $(CFLAGS) -fobjc-arc \
		...
		-o $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbupload \
		$(LDFLAGS) \
		$(PASTEBOARD-UTILS_LIBS)

	$(CC) $(CFLAGS) -fobjc-arc \
		$(BUILD_WORK)/pasteboard-utils/pbcopy/pbcopy.m \
		-o $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbcopy \
		$(LDFLAGS) \
		$(PASTEBOARD-UTILS_LIBS)
	
	$(CC) $(CFLAGS) -fobjc-arc \
		$(BUILD_WORK)/pasteboard-utils/pbpaste/pbpaste.m \
		-o $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbpaste \
		$(LDFLAGS) \
		$(PASTEBOARD-UTILS_LIBS)
...
pasteboard-utils-package: pasteboard-utils-stage
	...
	mkdir -p $(BUILD_DIST)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin

	# pasteboard-utils.mk Prep pasteboard-utils
	cp -a $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbupload $(BUILD_DIST)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
	cp -a $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbcopy $(BUILD_DIST)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
	cp -a $(BUILD_STAGE)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pbpaste $(BUILD_DIST)/pasteboard-utils/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
