...
#	Temporary SED until swift can build on their own apple silicon (cmon mac)
	...
	cd $(BUILD_WORK)/llvm/build && cmake . \
		...
		-DCMAKE_CXX_FLAGS="-std=c++17 -isystem $(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include -isystem $(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/local/include $(PLATFORM_VERSION_MIN)" \
