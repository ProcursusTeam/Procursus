...
ninja-setup: setup
	...
	mkdir -p $(BUILD_WORK)/ninja/build $(BUILD_STAGE)/ninja/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
...
ninja: ninja-setup
	...
	cp $(BUILD_WORK)/ninja/build/ninja $(BUILD_STAGE)/ninja/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/
...
ninja-package: ninja-stage
	...
	# ninja.mk Prep ninja
	cp -a $(BUILD_STAGE)/ninja/$(MEMO_PREFIX)$(MEMO_SUBPREFIX) $(BUILD_DIST)/ninja
