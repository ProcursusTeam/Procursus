...
basic-cmds-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/basic-cmds/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
...
basic-cmds: basic-cmds-setup ncurses
	...
	for bin in mesg write uudecode uuencode; do \
    	$(CC) -arch $(MEMO_ARCH) -isysroot $(TARGET_SYSROOT) $(PLATFORM_VERSION_MIN) -o $(BUILD_STAGE)/basic-cmds/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/$$bin $$bin/*.c; \
	done
