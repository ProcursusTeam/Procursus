...
python3-setup: setup
	...
	$(SED) -i -e "s|self.compiler.library_dirs|['$(TARGET_SYSROOT)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib'] + ['$(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib']|g" -e "s|self.compiler.include_dirs|['$(TARGET_SYSROOT)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include'] + ['$(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include']|g" -e "s/HOST_PLATFORM == 'darwin'/HOST_PLATFORM.startswith('darwin')/" $(BUILD_WORK)/python3/setup.py
