...
whois-package: whois-stage
	...
	mkdir -p $(BUILD_DIST)/whois/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,share}
	
	# whois.mk Prep WHOIS
	cp -a $(BUILD_STAGE)/whois/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,share} $(BUILD_DIST)/whois/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
