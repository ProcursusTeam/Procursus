...
bootstrap-cmds-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/bootstrap-cmds/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,libexec}
...
bootstrap-cmds: bootstrap-cmds-setup
	...
	cp -a migcom $(BUILD_STAGE)/bootstrap-cmds/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec; \
	cp -a mig.sh $(BUILD_STAGE)/bootstrap-cmds/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/mig
...
bootstrap-cmds-package: bootstrap-cmds-stage
	...
	$(FAKEROOT) chmod a+x $(BUILD_DIST)/bootstrap-cmds/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/mig
