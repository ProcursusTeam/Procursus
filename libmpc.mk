...
libmpc: libmpc-setup libgmp10 mpfr
...
libmpc-package: libmpc-stage
	...
	# libmpc.mk Prep mpc
	cp -a $(BUILD_STAGE)/mpc/usr/lib/libmpc*dylib $(BUILD_DIST)/libmpc/usr/lib
	...
	# libmpc.mk Sign
	$(call SIGN,libmpc,general.xml)
    	$(call SIGN,libmpc-dev,general.xml)
	
	# libmpc.mk Make .debs
	$(call PACK,libmpc,DEB_LIBMPC_V)
