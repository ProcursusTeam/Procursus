...
pincrush-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/pincrush/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
...
pincrush: pincrush-setup libpng16
	...
	$(CC) $(CFLAGS) $(LDFLAGS) -DVERSION=\"$(PINCRUSH_VERSION)\" -o $(BUILD_STAGE)/pincrush/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/pincrush pincrush.c -lpng16 -lz
...
pincrush-package: pincrush-stage
	...
	cp -a $(BUILD_STAGE)/pincrush/$(MEMO_PREFIX)$(MEMO_SUBPREFIX) $(BUILD_DIST)/pincrush
