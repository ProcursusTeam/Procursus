...
snaputil-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/snaputil/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
...
snaputil: snaputil-setup
	$(CC) -arch $(MEMO_ARCH) -Os -Wall -isysroot $(TARGET_SYSROOT) $(PLATFORM_VERSION_MIN) -o $(BUILD_STAGE)/snaputil/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/snaputil $(BUILD_WORK)/snaputil/snapUtil.c
