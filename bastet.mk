...
bastet-setup: setup
	...
	mkdir -p $(BUILD_STAGE)/bastet/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{bin,share/man/man6}
...
bastet: bastet-setup ncurses libboost
	+$(MAKE) -C $(BUILD_WORK)/bastet all \
		CXX="$(CXX) $(CXXFLAGS)"
	cp -a $(BUILD_WORK)/bastet/bastet $(BUILD_STAGE)/bastet/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
	cp -a $(BUILD_WORK)/bastet/bastet.6 $(BUILD_STAGE)/bastet/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man6
