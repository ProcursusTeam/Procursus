...
iokittools-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://opensource.apple.com/tarballs/IOKitTools/IOKitTools-$(IOKITTOOLS_VERSION).tar.gz
	...
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/iokittools/include/IOKit \
