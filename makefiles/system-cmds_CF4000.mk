...
SYSTEM-CMDS_CF4000_VERSION := 979.100.8
DEB_SYSTEM-CMDS_CF4000_V   ?= $(SYSTEM-CMDS_CF4000_VERSION)-1
PWDARWIN_CF4000_COMMIT     := 72ae45ce6c025bc2359035cfb941b177149e88ae

system-cmds_CF4000-setup: setup libxcrypt
	$(call GITHUB_ARCHIVE,apple-oss-distributions,system_cmds,$(SYSTEM-CMDS_CF4000_VERSION),system_cmds-$(SYSTEM-CMDS_CF4000_VERSION))
	$(call EXTRACT_TAR,system_cmds-$(SYSTEM-CMDS_CF4000_VERSION).tar.gz,system_cmds-system_cmds-$(SYSTEM-CMDS_CF4000_VERSION),system-cmds)
	for f in $(BUILD_WORK)/system-cmds/*; do \
		$(LN_S) $$f $$f.tproj; \
	done
	...
	sed -i 's|ATTRIBUTE_NORETURN |ATTRIBUTE_NORETURN __attribute__((noreturn)) //|g' $(BUILD_WORK)/system-cmds/zic/private.h

ifneq ($(wildcard $(BUILD_WORK)/system-cmds/.build_complete),)
system-cmds_CF4000:
	@echo "Using previously built system-cmds."
else
system-cmds_CF4000: system-cmds-setup libxcrypt openpam libiosexec ncurses
...
system-cmds_CF4000-package:: DEB_SYSTEM-CMDS_V ?= $(SYSTEM-CMDS_CF4000_VERSION)
system-cmds_CF4000-package: system-cmds-stage
...
.PHONY: system-cmds_CF4000 system-cmds_CF4000-package
