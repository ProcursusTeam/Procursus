...
libimobiledevice-glue-package: libimobiledevice-glue-stage
	...
	rm -rf $(BUILD_DIST)/libimobiledevice-glue{1.0-0,-dev}
	mkdir -p $(BUILD_DIST)/libimobiledevice-glue{1.0-0,-dev}/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib \

	# libimobiledevice-glue.mk Prep libimobiledevice-glue
	cp -a $(BUILD_STAGE)/libimobiledevice-glue/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libimobiledevice-glue-1.0.0.dylib $(BUILD_DIST)/libimobiledevice-glue1.0-0/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	...
	$(call SIGN,libimobiledevice-glue1.0-0,general.xml)

	# libimobiledevice-glue.mk Make .debs
	$(call PACK,libimobiledevice-glue1.0-0,DEB_LIBIMOBILEDEVICEGLUE_V)
