...
pojavlauncher: pojavlauncher-setup
	...
	cd $(BUILD_WORK)/pojavlauncher; \
		...
		cd Natives; \
			...
			xcrun actool Natives/Assets.xcassets --compile Natives/resources --platform iphoneos --minimum-deployment-target $(IPHONEOS_DEPLOYMENT_TARGET) --app-icon AppIcon --output-partial-info-plist /dev/null; \
