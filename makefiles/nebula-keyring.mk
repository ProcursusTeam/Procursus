...
DEB_NEBULA_KEYRING_V   ?= $(NEBULA_KEYRING_VERSION)-1
...
nebula-keyring-package: nebula-keyring-stage
	...
	mkdir -p $(BUILD_DIST)/nebula-keyring/$(MEMO_PREFIX)/usr/share/keyrings

	# nebula-keyring.mk Prep nebula-keyring
	cp -a $(BUILD_MISC)/keyrings/nebula/nebula.gpg $(BUILD_DIST)/nebula-keyring/$(MEMO_PREFIX)/usr/share/keyrings
