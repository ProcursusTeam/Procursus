...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/progress https://raw.githubusercontent.com/NetBSD/src/trunk/{lib/libc/gen/wordexp.c,include/wordexp.h}
