...
lua5.2-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://www.lua.org/ftp/lua-$(LUA5.2_VERSION).tar.gz)
...
lua5.2: lua5.2-setup readline
	...
	$(LN_S) liblua5.2.0.dylib $(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/liblua5.2.dylib
...
lua5.2-package: lua5.2-stage
	...
	$(INSTALL) -Dm644 $(BUILD_STAGE)/lua5.2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/lua.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/lua5.2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/lua5.2.1$(MEMO_MANPAGE_SUFFIX)
	$(INSTALL) -Dm644 $(BUILD_STAGE)/lua5.2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/luac.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/lua5.2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/luac5.2.1$(MEMO_MANPAGE_SUFFIX)
	...
	$(LN_S) liblua5.2.0.dylib $(BUILD_DIST)/liblua5.2-0/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/liblua5.2.0.0.0.dylib
	...
	$(LN_S) liblua5.2.0.dylib $(BUILD_DIST)/liblua5.2-dev/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/liblua5.2.dylib
