...
x11-apps-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir$(BUILD_SOURCE) https://salsa.debian.org/xorg-team/app/x11-apps/-/archive/x11-apps-$(X11_APPS_VERSION)/x11-apps-x11-apps-$(X11_APPS_VERSION).tar.gz
