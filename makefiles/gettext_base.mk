...
gettext_CFbase: .SHELLFLAGS=-O extglob -c
gettext_CFbase: gettext-setup ncurses libunistring
...
gettext_CFbase-package:: DEB_GETTEXT_V ?= $(GETTEXT_CFBASE_VERSION)
gettext_CFbase-package: gettext-stage
	...
	cp -a $(BUILD_STAGE)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/{libgettext{lib,src}-$(GETTEXT_CFBASE_VERSION).dylib,gettext} $(BUILD_DIST)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
...
.PHONY: gettext_CFbase gettext_CFbase-package
