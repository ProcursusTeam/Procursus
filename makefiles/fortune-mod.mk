...
fortune-mod-setup: setup
	wget2 -q -nc -P $(BUILD_SOURCE) https://github.com/shlomif/fortune-mod/releases/download/fortune-mod-$(FORTUNE-MOD_VERSION)/fortune-mod-$(FORTUNE-MOD_VERSION).tar.xz
