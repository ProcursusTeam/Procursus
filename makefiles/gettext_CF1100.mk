...
GETTEXT_CF1100_VERSION := 0.21.1

gettext_CF1100-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://mirrors.kernel.org/gnu/gettext/gettext-$(GETTEXT_CF1100_VERSION).tar.xz{$(comma).sig})
...
gettext_CF1100: .SHELLFLAGS=-O extglob -c
gettext_CF1100: gettext-setup ncurses libunistring
...
gettext_CF1100-package:: DEB_GETTEXT_V ?= $(GETTEXT_CF1100_VERSION)
gettext_CF1100-package: gettext-stage
	...
	cp -a $(BUILD_STAGE)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/{libgettext{lib,src}-$(GETTEXT_CF1100_VERSION).dylib,gettext} $(BUILD_DIST)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
...
.PHONY: gettext_CF1100 gettext_CF1100-package
