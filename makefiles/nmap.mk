...
nmap-package: nmap-stage
	...
	mkdir -p $(BUILD_DIST)/n{map,cat}/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/bin
	for lang in '' $(NMAP_MANPAGE_LANGS); do \
		[ -f $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/ncat.1$(MEMO_MANPAGE_SUFFIX) ] && \
			mkdir -p $(BUILD_DIST)/ncat/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1; \
		if [ -f $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/nmap.1$(MEMO_MANPAGE_SUFFIX) ] || [ -f $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/nping.1$(MEMO_MANPAGE_SUFFIX) ]; then \
			mkdir -p $(BUILD_DIST)/nmap/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1; \
		fi; \
	done;
	...
	for lang in '' $(NMAP_MANPAGE_LANGS); do \
		if [ -d $(BUILD_DIST)/nmap/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1 ]; then \
			if [ -f $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/nmap.1$(MEMO_MANPAGE_SUFFIX) ]; then \
				cp -a $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/nmap.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/nmap/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1; \
			fi; \
			if [ -f $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/nping.1$(MEMO_MANPAGE_SUFFIX) ]; then \
				cp -a $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/nping.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/nmap/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1; \
			fi; \
		fi; \
	done
	...
	for lang in '' $(NMAP_MANPAGE_LANGS); do \
		[ -d $(BUILD_DIST)/ncat/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1 ] && \
			cp -a $(BUILD_STAGE)/nmap/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1/ncat.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/ncat/$(MEMO_PREFIXX)$(MEMO_SUB_PREFIX)/share/man/$${lang}/man1 ; \
	done; true
