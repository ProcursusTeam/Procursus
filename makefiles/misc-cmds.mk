...
misc-cmds-setup: setup
	$(call GITHUB_ARCHIVE,apple-oss-distributions,misc_cmds,$(MISC-CMDS_VERSION),misc_cmds-$(MISC-CMDS_VERSION))
	$(call EXTRACT_TAR,misc_cmds-$(MISC-CMDS_VERSION).tar.gz,misc_cmds-misc_cmds-$(MISC-CMDS_VERSION),misc-cmds)
