...
setup_CF2000:
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/libsyscall/wrappers/{spawn/spawn{$(comma)_private}$(comma)libproc/libproc{$(comma)_internal$(comma)_private}}.h \
		...
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/{EXTERNAL_HEADERS/mach-o/nlist$(comma)osfmk/mach/vm_statistics}.h \
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/kern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/osfmk/kern/ledger.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/IOKit, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/iokit/IOKit/IOKitDebug.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/Kernel/libkern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/libkern/libkern/OSKextLibPrivate.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/kern,https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/osfmk/kern/debug.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/arm, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/{bsd/arm/disklabel$(comma)osfmk/arm/cpu_capabilities}.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/machine, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/bsd/machine/disklabel.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/os, \
		...
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/libkern/os/{base_private$(comma)log_private$(comma)log}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/bsm, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/bsd/bsm/audit_kevents.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/machine, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/osfmk/machine/cpu_capabilities.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/firehose, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/libkern/firehose/{tracepoint$(comma)firehose_types}_private.h)

	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/libkern, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5//libkern/libkern/{OSKextLibPrivate$(comma)mkext$(comma)prelink}.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/osfmk/mach/coalition.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/firehose, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/libkern/firehose/tracepoint_private.h \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/libkern/firehose/firehose_types_private.h)
	...
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/bsd/sys/{fcntl$(comma)fsctl$(comma)spawn_internal$(comma)resource$(comma)event$(comma)kdebug$(comma)proc$(comma)proc_info$(comma)pgo$(comma)proc_uuid_policy$(comma)acct$(comma)stackshot$(comma)event$(comma)mbuf$(comma)kern_memorystatus$(comma)reason}.h)
...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
	@$(call DOWNLOAD_FILES,$(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sys, \
		https://github.com/apple-oss-distributions/xnu/raw/xnu-8796.101.5/bsd/sys/resource.h \
...
ifneq (,$(findstring ramdisk,$(MEMO_TARGET)))
	# WatchOS 10.0 ramdisk Watch4,1
	@sed -E -e 's/res_9_dn_expand/dn_expand/g' -e 's/res_9_init/res_init/g' -e 's/res_9_query/res_query/g' -e 's/res_9_search/res_search/g' < $(TARGET_SYSROOT)/usr/include/resolv.h > $(BUILD_BASE)$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/resolv.h
