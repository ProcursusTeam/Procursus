...
po4a-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://github.com/mquinson/po4a/releases/download/v$(PO4A_VERSION)/po4a-$(PO4A_VERSION).tar.gz
