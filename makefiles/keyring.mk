...
keyring: setup
	mkdir -p $(BUILD_STAGE)/keyring/$(MEMO_PREFIX)/usr/share/keyrings
	cp -a $(BUILD_MISC)/keyrings/procursus/memo.gpg $(BUILD_STAGE)/keyring/$(MEMO_PREFIX)/usr/share/keyrings
	$(call AFTER_BUILD)
endif
