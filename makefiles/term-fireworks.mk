...
term-fireworks-setup: setup
	curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://gitlab.com/DarrienG/term-fireworks/-/archive/v$(TERM-FIREWORKS_VERSION)/term-fireworks-v$(TERM-FIREWORKS_VERSION).tar.bz2
