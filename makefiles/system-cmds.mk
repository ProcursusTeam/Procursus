...
system-cmds-setup: setup libxcrypt
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://opensource.apple.com/tarballs/system_cmds/system_cmds-$(SYSTEM-CMDS_VERSION).tar.gz
	...
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/system-cmds/include \
