...
PWDARWIN_COMMIT     := 3de6f8f6ed62ac8b9b8f7635a7c4bb48b06322ca
DEB_SYSTEM-CMDS_V   ?= $(SYSTEM-CMDS_VERSION)-12
...
ifneq ($(MEMO_SUB_PREFIX),)
	$(LN_S) $(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/sbin/reboot $(BUILD_STAGE)/system-cmds/$(MEMO_PREFIX)/sbin/halt
endif
	...
	$(LN_S) reboot.8.zst $(BUILD_STAGE)/system-cmds$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man8/halt.8.zst
