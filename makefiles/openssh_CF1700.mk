...
OPENSSH_CF1700_VERSION := 9.2p1

openssh_CF1700-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://cdn.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-$(OPENSSH_CF1700_VERSION).tar.gz{$(comma).asc})
	$(call PGP_VERIFY,openssh-$(OPENSSH_CF1700_VERSION).tar.gz,asc)
	$(call EXTRACT_TAR,openssh-$(OPENSSH_CF1700_VERSION).tar.gz,openssh-$(OPENSSH_CF1700_VERSION),openssh)
...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
ifeq (,$(findstring ramdisk,$(MEMO_TARGET)))
openssh_CF1700: openssh-setup openssl libxcrypt openpam libmd
else #(,$(findstring ramdisk,$(MEMO_TARGET)))
openssh_CF1700: openssh-setup openssl libmd
endif #(,$(findstring ramdisk,$(MEMO_TARGET)))
...
openssh_CF1700-package:: DEB_OPENSSH_V ?= $(OPENSSH_CFBASE_VERSION)
openssh_CF1700-package: openssh-stage
...
.PHONY: openssh_CF1700 openssh_CF1700-package
