...
GETTEXT_CF1500_VERSION := 0.21.1

gettext_CF1500-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://mirrors.kernel.org/gnu/gettext/gettext-$(GETTEXT_CF1500_VERSION).tar.xz{$(comma).sig})
	$(call PGP_VERIFY,gettext-$(GETTEXT_CF1500_VERSION).tar.xz)
	$(call EXTRACT_TAR,gettext-$(GETTEXT_CF1500_VERSION).tar.xz,gettext-$(GETTEXT_CF1500_VERSION),gettext)
...
gettext_CF1500: .SHELLFLAGS=-O extglob -c
gettext_CF1500: gettext-setup ncurses libunistring
...
gettext_CF1500-package:: DEB_GETTEXT_V ?= $(GETTEXT_CF1500_VERSION)
gettext_CF1500-package: gettext-stage
	...
	cp -a $(BUILD_STAGE)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/{libgettext{lib,src}-$(GETTEXT_CF1500_VERSION).dylib,gettext} $(BUILD_DIST)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
...
.PHONY: gettext_CF1500 gettext_CF1500-package
