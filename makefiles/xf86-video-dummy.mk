...
xf86-video-dummy-setup: setup
	curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://www.x.org/archive/individual/driver/xf86-video-dummy-$(DUMMY_VERSION).tar.gz{,.sig}
