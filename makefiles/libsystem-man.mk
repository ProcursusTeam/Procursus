...
libsystem-man-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://sudhip.com/files/darwin-manpages/$(LIBSYSTEM-MAN_VERSION)/man{2,3,4}.tar.zst{,.sig}
