...
apt-rdepends-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) http://deb.debian.org/debian/pool/main/a/apt-rdepends/apt-rdepends_$(APT-RDEPENDS_VERSION).orig.tar.gz
