...
DEB_DEON_KEYRING_V   ?= $(DEON_KEYRING_VERSION)-1
...
deon-keyring-package: deon-keyring-stage
	...
	mkdir -p $(BUILD_DIST)/deon-keyring/$(MEMO_PREFIX)/usr/share/keyrings

	# deon-keyring.mk Prep deon-keyring
	cp -a $(BUILD_MISC)/keyrings/deon/deontw.gpg $(BUILD_DIST)/deon-keyring/$(MEMO_PREFIX)/usr/share/keyrings
