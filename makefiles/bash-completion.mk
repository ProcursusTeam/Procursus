...
bash-completion-setup: setup
	wget2 -q -nc -P $(BUILD_SOURCE) https://github.com/scop/bash-completion/releases/download/$(BASH-COMPLETION_VERSION)/bash-completion-$(BASH-COMPLETION_VERSION).tar.xz
