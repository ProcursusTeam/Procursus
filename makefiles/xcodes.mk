...
xcodes: xcodes-setup
	cd $(BUILD_WORK)/xcodes; \
		swift build -c release \
			...
			--disable-sandbox
	$(BUILD_WORK)/xcodes/.build/release/xcodes --generate-completion-script zsh > $(BUILD_STAGE)/xcodes/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/zsh/site-functions/_xcodes
	$(BUILD_WORK)/xcodes/.build/release/xcodes --generate-completion-script bash > $(BUILD_STAGE)/xcodes/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/bash-completion/completions/xcodes
	$(BUILD_WORK)/xcodes/.build/release/xcodes --generate-completion-script fish > $(BUILD_STAGE)/xcodes/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/fish/vendor_completions.d/xcodes.fish
