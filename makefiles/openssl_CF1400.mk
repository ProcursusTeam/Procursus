...
OPENSSL_CF1400_VERSION := 3.0.8

openssl_CF1400-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://www.openssl.org/source/openssl-$(OPENSSL_CF1400_VERSION).tar.gz{$(comma).asc})
	$(call PGP_VERIFY,openssl-$(OPENSSL_CF1400_VERSION).tar.gz,asc)
	$(call EXTRACT_TAR,openssl-$(OPENSSL_CF1400_VERSION).tar.gz,openssl-$(OPENSSL_CF1400_VERSION),openssl)
...
openssl_CF1400-package:: DEB_OPENSSL_V ?= $(OPENSSL_CF1400_VERSION)
openssl_CF1400-package: openssl-stage
...
.PHONY: openssl_CF1400 openssl_CF1400-package
