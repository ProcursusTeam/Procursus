...
DEB_ODYSSEY_KEYRING_V   ?= $(ODYSSEY_KEYRING_VERSION)-1
...
odyssey-keyring-package: odyssey-keyring-stage
	...
	mkdir -p $(BUILD_DIST)/odyssey-keyring/$(MEMO_PREFIX)/usr/share/keyrings

	# odyssey-keyring.mk Prep odyssey-keyring
	cp -a $(BUILD_MISC)/keyrings/odyssey/odyssey.gpg $(BUILD_DIST)/odyssey-keyring/$(MEMO_PREFIX)/usr/share/keyrings
