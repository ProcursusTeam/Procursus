...
joe-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://sourceforge.net/projects/joe-editor/files/JOE%20sources/joe-$(JOE_VERSION)/joe-$(JOE_VERSION).tar.gz
