...
DEB_PROPR_KEYRING_V   ?= $(PROPR_KEYRING_VERSION)-1
...
propr-keyring-package: propr-keyring-stage
	...
	mkdir -p $(BUILD_DIST)/propr-keyring/$(MEMO_PREFIX)/usr/share/keyrings

	# propr-keyring.mk Prep propr-keyring
	cp -a $(BUILD_MISC)/keyrings/propr/propr.gpg $(BUILD_DIST)/propr-keyring/$(MEMO_PREFIX)/usr/share/keyrings
