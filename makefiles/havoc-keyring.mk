...
DEB_HAVOC_KEYRING_V   ?= $(HAVOC_KEYRING_VERSION)-1
...
havoc-keyring-package: havoc-keyring-stage
	...
	mkdir -p $(BUILD_DIST)/havoc-keyring/$(MEMO_PREFIX)/usr/share/keyrings

	# havoc-keyring.mk Prep havoc-keyring
	cp -a $(BUILD_MISC)/keyrings/havoc/havoc.gpg $(BUILD_DIST)/havoc-keyring/$(MEMO_PREFIX)/usr/share/keyrings
