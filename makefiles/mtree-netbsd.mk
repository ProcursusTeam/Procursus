...
mtree-netbsd-setup: setup
	...
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/mtree-netbsd https://raw.githubusercontent.com/NetBSD/src/trunk/lib/libc/gen/pwcache.{c,h}
