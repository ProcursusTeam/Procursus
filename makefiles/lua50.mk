...
lua50-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://www.lua.org/ftp/lua-$(LUA50_VERSION).tar.gz)
...
lua50-package: lua50-stage
	...
	$(INSTALL) -Dm644 $(BUILD_STAGE)/lua50/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/lua.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/lua50/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/lua50.1$(MEMO_MANPAGE_SUFFIX)
	$(INSTALL) -Dm644 $(BUILD_STAGE)/lua50/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/luac.1$(MEMO_MANPAGE_SUFFIX) $(BUILD_DIST)/lua50/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/luac50.1$(MEMO_MANPAGE_SUFFIX)
