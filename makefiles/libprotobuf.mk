...
libprotobuf-package: libprotobuf-stage
	...
	rm -rf $(BUILD_DIST)/libprotobuf{{,-lite}28,-dev} $(BUILD_DIST)/libprotoc{28,-dev} $(BUILD_DIST)/protobuf-compiler
	mkdir -p $(BUILD_DIST)/libprotobuf28/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib \
		$(BUILD_DIST)/libprotobuf-lite28/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib \
		$(BUILD_DIST)/libprotobuf-dev/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/{include/google/protobuf,lib} \
		$(BUILD_DIST)/libprotoc28/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib \
	...
	# libprotobuf.mk Prep libprotobuf28
	cp -a $(BUILD_STAGE)/libprotobuf/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libprotobuf.28.dylib $(BUILD_DIST)/libprotobuf28/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	
	# libprotobuf.mk Prep libprotobuf-lite28
	cp -a $(BUILD_STAGE)/libprotobuf/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libprotobuf-lite.28.dylib $(BUILD_DIST)/libprotobuf-lite28/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	...
	# libprotobuf.mk Prep libprotoc28
	cp -a $(BUILD_STAGE)/libprotobuf/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libprotoc.28.dylib $(BUILD_DIST)/libprotoc28/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	...
	# libprotobuf.mk Sign
	$(call SIGN,libprotobuf28,general.xml)
	$(call SIGN,libprotobuf-lite28,general.xml)
	$(call SIGN,libprotoc28,general.xml)
	$(call SIGN,protobuf-compiler,general.xml)
	
	# libprotobuf.mk Make .debs
	$(call PACK,libprotobuf28,DEB_LIBPROTOBUF_V)
	$(call PACK,libprotobuf-lite28,DEB_LIBPROTOBUF_V)
	$(call PACK,libprotobuf-dev,DEB_LIBPROTOBUF_V)
	$(call PACK,libprotoc28,DEB_LIBPROTOBUF_V)
