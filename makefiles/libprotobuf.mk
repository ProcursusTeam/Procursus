...
libprotobuf-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://github.com/protocolbuffers/protobuf/releases/download/v$(LIBPROTOBUF_VERSION)/protobuf-cpp-$(LIBPROTOBUF_VERSION).tar.gz)
