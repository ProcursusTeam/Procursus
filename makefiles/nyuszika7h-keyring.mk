...
DEB_NYUSZIKA7H_KEYRING_V    ?= $(NYUSZIKA7H_KEYRING_VERSION)-1
...
nyuszika7h-keyring-package: nyuszika7h-keyring-stage
	...
	mkdir -p $(BUILD_DIST)/nyuszika7h-keyring/$(MEMO_PREFIX)/usr/share/keyrings

	# nyuszika7h-keyring.mk Prep nyuszika7h-keyring
	cp -a $(BUILD_MISC)/keyrings/nyuszika7h/nyuszika7h.gpg $(BUILD_DIST)/nyuszika7h-keyring/$(MEMO_PREFIX)/usr/share/keyrings
