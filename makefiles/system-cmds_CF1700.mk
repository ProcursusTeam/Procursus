...
SYSTEM-CMDS_CF1700_VERSION := 880.60.2
DEB_SYSTEM-CMDS_CF1700_V   ?= $(SYSTEM-CMDS_CF1700_VERSION)-1
PWDARWIN_CF1700_COMMIT     := 72ae45ce6c025bc2359035cfb941b177149e88ae

system-cmds_CF1700-setup: setup libxcrypt
	$(call GITHUB_ARCHIVE,apple-oss-distributions,system_cmds,$(SYSTEM-CMDS_CF1700_VERSION),system_cmds-$(SYSTEM-CMDS_CF1700_VERSION))
	$(call EXTRACT_TAR,system_cmds-$(SYSTEM-CMDS_CF1700_VERSION).tar.gz,system_cmds-system_cmds-$(SYSTEM-CMDS_CF1700_VERSION),system-cmds)
	...
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE), \
		https://git.cameronkatri.com/pw-darwin/snapshot/pw-darwin-$(PWDARWIN_CF1700_COMMIT).tar.zst)
	$(call EXTRACT_TAR,pw-darwin-$(PWDARWIN_CF1700_COMMIT).tar.zst,pw-darwin-$(PWDARWIN_CF1700_COMMIT),system-cmds/pw-darwin)
...
system-cmds_CF1700: system-cmds-setup libxcrypt openpam libiosexec ncurses
...
system-cmds_CF1700-package:: DEB_SYSTEM-CMDS_V ?= $(SYSTEM-CMDS_CF1700_VERSION)
system-cmds_CF1700-package: system-cmds-stage
...
.PHONY: system-cmds_CF1700 system-cmds_CF1700-package
