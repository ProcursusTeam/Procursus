...
XWALLPAPER_VERSION := 0.7.3
DEB_XWALLPAPER_V   ?= $(XWALLPAPER_VERSION)

xwallpaper-setup: setup
	wget -q -nc -P $(BUILD_SOURCE) https://github.com/stoeckmann/xwallpaper/releases/download/v$(XWALLPAPER_VERSION)/xwallpaper-$(XWALLPAPER_VERSION).tar.xz{,.sig}
