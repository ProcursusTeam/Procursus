...
youtube-dl-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://github.com/ytdl-org/youtube-dl/releases/download/$(YOUTUBE-DL_VERSION)/youtube-dl-$(YOUTUBE-DL_VERSION).tar.gz{$(comma).sig})
