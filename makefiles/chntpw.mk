...
chntpw-setup: setup
	curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir$(BUILD_SOURCE) https://deb.debian.org/debian/pool/main/c/chntpw/chntpw_$(CHNTPW_VERSION).orig.tar.gz
