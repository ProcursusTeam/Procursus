...
pam-modules-setup: setup
	-curl --silent -Z --create-dirs -C - --remote-name-all --output-dir$(BUILD_SOURCE) https://opensource.apple.com/tarballs/pam_modules/pam_modules-$(PAM-MODULES_VERSION).tar.gz
	...
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/pam-modules/include \
