...
libideviceactivation-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://github.com/libimobiledevice/libideviceactivation/releases/download/$(LIBIDEVICEACTIVATION_VERSION)/libideviceactivation-$(LIBIDEVICEACTIVATION_VERSION).tar.bz2)
