...
pongoterm-setup: setup
	...
	curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir$(BUILD_WORK)/pongoterm/scripts https://opensource.apple.com/source/Libc/Libc-997.90.3/gen/wordexp.c
