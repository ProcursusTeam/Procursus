...
network-cmds-setup: setup
	curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://opensource.apple.com/tarballs/network_cmds/network_cmds-$(NETWORK-CMDS_VERSION).tar.gz
	...
	@curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/network-cmds/include/net \
	...
	@curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/network-cmds/include/net/pktsched \
	...
	@curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/network-cmds/include/net/classq \
	...
	@curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/network-cmds/include/netinet \
	...
	@curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/network-cmds/include/netinet6 \
	...
	@curl --silent -L -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_WORK)/network-cmds/include/sys \
