...
OPENSSH_CF5000_VERSION := 10.5p1

openssh_CF5000-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://cdn.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-$(OPENSSH_CF5000_VERSION).tar.gz{$(comma).asc})
	$(call PGP_VERIFY,openssh-$(OPENSSH_CF5000_VERSION).tar.gz,asc)
	$(call EXTRACT_TAR,openssh-$(OPENSSH_CF5000_VERSION).tar.gz,openssh-$(OPENSSH_CF5000_VERSION),openssh)
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
	$(call DO_PATCH,openssh-cf5000,openssh,-p1)
endif
...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
ifeq (,$(findstring ramdisk,$(MEMO_TARGET)))
openssh_CF5000: openssh-setup openssl libxcrypt openpam libmd
else #(,$(findstring ramdisk,$(MEMO_TARGET)))
openssh_CF5000: openssh-setup openssl libmd
endif #(,$(findstring ramdisk,$(MEMO_TARGET)))
...
openssh_CF5000-package:: DEB_OPENSSH_V ?= $(OPENSSH_CFBASE_VERSION)
openssh_CF5000-package: openssh-stage
...
ifeq (,$(findstring ramdisk,$(MEMO_TARGET)))
	...
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/libexec/sshd-{keygen-wrapper,session,auth} $(BUILD_DIST)/openssh-server/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/libexec
ifeq (,$(findstring ramdisk,$(MEMO_TARGET)))
...
.PHONY: openssh_CF5000 openssh_CF5000-package
