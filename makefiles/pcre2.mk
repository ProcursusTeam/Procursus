...
pcre2-package: pcre2-stage
	...
	rm -rf $(BUILD_DIST)/libpcre2-{{8,16,32}-0,dev,posix3} $(BUILD_DIST)/pcre2-utils
	mkdir -p $(BUILD_DIST)/libpcre2-{{8,16,32}-0,posix3}/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib \
	...
	cp -a $(BUILD_STAGE)/pcre2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/!(pcre2-config.1.zst) $(BUILD_DIST)/pcre2-utils/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1
	...
	# pcre2.mk Prep libpcre2-posix3
	cp -a $(BUILD_STAGE)/pcre2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libpcre2-posix.3.dylib $(BUILD_DIST)/libpcre2-posix3/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	...
	cp -a $(BUILD_STAGE)/pcre2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1/pcre2-config.1.zst $(BUILD_DIST)/libpcre2-dev/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man1
	...
	$(call SIGN,libpcre2-posix3,general.xml)
	...
	$(call PACK,libpcre2-posix3,DEB_PCRE2_V)
