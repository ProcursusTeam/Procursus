...
gettext_CF3000: .SHELLFLAGS=-O extglob -c
gettext_CF3000: gettext-setup ncurses libunistring
...
gettext_CF3000-package:: DEB_GETTEXT_V ?= $(GETTEXT_CF3000_VERSION)
gettext_CF3000-package: gettext-stage
	...
	cp -a $(BUILD_STAGE)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/{libgettext{lib,src}-$(GETTEXT_CF3000_VERSION).dylib,gettext} $(BUILD_DIST)/gettext/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
...
.PHONY: gettext_CF3000 gettext_CF3000-package
