...
ifeq (,$(findstring darwin,$(MEMO_TARGET)))
	...
	@cp -af $(MACOSX_SYSROOT)/usr/include/mach-o/arm $(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/mach-o
...
ifneq (,$(findstring ramdisk,$(MEMO_TARGET)))
	...
	@cp -af $(TARGET_SYSROOT)/usr/include/sandbox.h $(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/
	@echo 'extern const char kSBXProfilePureComputation[];'>> $(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/sandbox.h
