...
pam-biometrics: pam-biometrics-setup openpam
	...
	curl --silent -L -Z --create-dirs --remote-name-all --output \
		$(BUILD_STAGE)/pam-biometrics/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/man/man8/pam_biometrics.8 \
		https://gist.githubusercontent.com/1Conan/992efca8fb1ac1551432b7a744817faf/raw/b304293cd378aefbcceb22d427794f2777f09088/pam-biometrics.8.txt
	$(LN_S) pam_biometrics.so $(BUILD_STAGE)/pam-biometrics/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/pam/pam-biometrics.so
