...
SYSTEM-CMDS_CFBASE_VERSION := 854.40.2
DEB_SYSTEM-CMDS_CFBASE_V   ?= $(SYSTEM-CMDS_CFBASE_VERSION)-1
PWDARWIN_CFBASE_COMMIT     := 72ae45ce6c025bc2359035cfb941b177149e88ae


system-cmds_CFbase-setup: setup libxcrypt
	$(call GITHUB_ARCHIVE,apple-oss-distributions,system_cmds,$(SYSTEM-CMDS_CFBASE_VERSION),system_cmds-$(SYSTEM-CMDS_CFBASE_VERSION))
	$(call EXTRACT_TAR,system_cmds-$(SYSTEM-CMDS_CFBASE_VERSION).tar.gz,system_cmds-system_cmds-$(SYSTEM-CMDS_CFBASE_VERSION),system-cmds)
	...
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE), \
		https://git.cameronkatri.com/pw-darwin/snapshot/pw-darwin-$(PWDARWIN_CFBASE_COMMIT).tar.zst)
	$(call EXTRACT_TAR,pw-darwin-$(PWDARWIN_CFBASE_COMMIT).tar.zst,pw-darwin-$(PWDARWIN_CFBASE_COMMIT),system-cmds/pw-darwin)
...
system-cmds_CFbase: system-cmds-setup libxcrypt openpam libiosexec ncurses
...
.PHONY: system-cmds_CFbase system-cmds_CFbase-package
