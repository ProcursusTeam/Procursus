...
coreutils_CF1900-setup: setup
	...
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE), \
		https://git.cameronkatri.com/getent-darwin/snapshot/getent-darwin-$(GETENTDARWIN_CF1900_COMMIT).tar.zst)
	$(call EXTRACT_TAR,getent-darwin-$(GETENTDARWIN_CF1900_COMMIT).tar.zst,getent-darwin-$(GETENTDARWIN_CF1900_COMMIT),coreutils/getent-darwin)
