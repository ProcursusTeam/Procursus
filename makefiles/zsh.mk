...
zsh: zsh-setup pcre ncurses
	...
	cd $(BUILD_WORK)/zsh && ./configure -C \
		...
		ac_cv_prog_PCRECONF="libS='' libR='' $(BUILD_STAGE)/pcre/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/bin/pcre-config" \
		$(ZSH_CONFIGURE_ARGS)
...
zsh-package: zsh-stage
	...
	# zsh.mk Prep zsh
	cp -a $(BUILD_STAGE)/zsh $(BUILD_DIST)
ifneq ($(MEMO_SUB_PREFIX),)
	mkdir $(BUILD_DIST)/zsh/$(MEMO_PREFIX)/bin
