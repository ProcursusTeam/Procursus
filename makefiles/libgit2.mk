...
libgit2-package: libgit2-stage
	...
	rm -rf $(BUILD_DIST)/libgit2-{1.4,dev}
	mkdir -p $(BUILD_DIST)/libgit2-{1.4,dev}/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib

	# libgit2.mk Prep libgit2-1.4
	cp -a $(BUILD_STAGE)/libgit2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libgit2.1.4*.dylib $(BUILD_DIST)/libgit2-1.4/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	...
	# libgit2.mk Sign
	$(call SIGN,libgit2-1.4,general.xml)

	# libgit2.mk Make .debs
	$(call PACK,libgit2-1.4,DEB_LIBGIT2_V)
