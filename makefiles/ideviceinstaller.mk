...
ideviceinstaller-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://github.com/libimobiledevice/ideviceinstaller/releases/download/$(IDEVICEINSTALLER_VERSION)/ideviceinstaller-$(IDEVICEINSTALLER_VERSION).tar.bz2)
