...
myman-setup: setup
	curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $(BUILD_SOURCE) https://downloads.sourceforge.net/project/myman/myman-cvs/myman-cvs-$(MYMAN_VERSION)/myman-wip-$(MYMAN_VERSION).tar.gz
