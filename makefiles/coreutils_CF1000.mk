...
COREUTILS_CF1000_VERSION   := 9.1
GETENTDARWIN_CF1000_COMMIT := 1ad0e39ee51181ea6c13b3d1d4e9c6005ee35b5e

COREUTILS_CF1000_CONFIGURE_ARGS += ac_cv_func_rpmatch=no

ifneq (,$(findstring darwin,$(MEMO_TARGET)))
COREUTILS_CF1000_CONFIGURE_ARGS += --program-prefix=$(GNU_PREFIX)
endif

coreutils_CF1000-setup: setup
	$(call DOWNLOAD_FILES,$(BUILD_SOURCE),https://mirrors.kernel.org/gnu/coreutils/coreutils-$(COREUTILS_CF1000_VERSION).tar.xz{$(comma).sig})
	$(call PGP_VERIFY,coreutils-$(COREUTILS_CF1000_VERSION).tar.xz)
...
coreutils_CF1000: coreutils-setup
else ifeq (,$(findstring darwin,$(MEMO_TARGET)))
coreutils_CF1000: coreutils-setup gettext libgmp10 libxcrypt openssl
else # (,$(findstring darwin,$(MEMO_TARGET)))
coreutils_CF1000: coreutils-setup gettext libgmp10 openssl
endif # (,$(findstring darwin,$(MEMO_TARGET)))
	cd $(BUILD_WORK)/coreutils && ./configure -C \
		$(DEFAULT_CONFIGURE_FLAGS) \
		$(COREUTILS_CF1000_CONFIGURE_ARGS)
...
coreutils_CF1000-package:: DEB_COREUTILS_V ?= $(COREUTILS_CF1000_VERSION)
coreutils_CF1000-package: coreutils-stage
...
.PHONY: coreutils_CF1000 coreutils_CF1000-package
