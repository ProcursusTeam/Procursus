...
libxml2: libxml2-setup xz ncurses readline
	...
	cd $(BUILD_WORK)/libxml2/python && $(DEFAULT_SETUP_PY_ENV) python3 ./setup.py \
		install \
...
libxml2-package: libxml2-stage
	...
	mkdir -p $(BUILD_DIST)/{python3-,}libxml2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib \
	...
	cp -a $(BUILD_STAGE)/libxml2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/!(libxml2.2.dylib|python3) $(BUILD_DIST)/libxml2-dev/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
