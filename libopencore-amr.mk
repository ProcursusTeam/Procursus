...
libopencore-amr-package: libopencore-amr-stage
	...
	mkdir -p $(BUILD_DIST)/libopencore-amr{n,w}b{0,-dev}/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib \
		$(BUILD_DIST)/libopencore-amr{n,w}b-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include

	# libopencore-amr.mk Prep libopencore-amrnb0
	cp -a $(BUILD_STAGE)/libopencore-amr/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libopencore-amrnb.0.dylib $(BUILD_DIST)/libopencore-amrnb0/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib

	# libopencore-amr.mk Prep libopencore-amrnb-dev
	cp -a $(BUILD_STAGE)/libopencore-amr/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libopencore-amrnb.{dylib,a} $(BUILD_DIST)/libopencore-amrnb-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib
	cp -a $(BUILD_STAGE)/libopencore-amr/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include/opencore-amrnb $(BUILD_DIST)/libopencore-amrnb-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include

	# libopencore-amr.mk Prep libopencore-amrwb0
	cp -a $(BUILD_STAGE)/libopencore-amr/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libopencore-amrwb.0.dylib $(BUILD_DIST)/libopencore-amrwb0/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib

	# libopencore-amr.mk Prep libopencore-amrwb-dev
	cp -a $(BUILD_STAGE)/libopencore-amr/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libopencore-amrwb.{dylib,a} $(BUILD_DIST)/libopencore-amrwb-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib
	cp -a $(BUILD_STAGE)/libopencore-amr/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include/opencore-amrwb $(BUILD_DIST)/libopencore-amrwb-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/include
