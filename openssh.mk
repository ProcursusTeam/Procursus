...
openssh: openssh-setup openssl libxcrypt
	...
	cp $(BUILD_INFO)/sshd-keygen-wrapper $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec
	cp $(BUILD_WORK)/openssh/contrib/ssh-copy-id $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin
	chmod 0755 $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/ssh-copy-id
...
openssh-package: openssh-stage
	...
	mkdir -p $(BUILD_DIST)/openssh \
		...
		$(BUILD_DIST)/openssh-sftp-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{libexec,/share/man/man8}
	
	# openssh.mk Prep openssh-client
	cp -a $(BUILD_STAGE)/openssh/etc/ssh/ssh_config $(BUILD_DIST)/openssh-client/etc/ssh
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin $(BUILD_DIST)/openssh-client/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec/{ssh-keysign,ssh-pkcs11-helper,ssh-sk-helper} $(BUILD_DIST)/openssh-client/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1 $(BUILD_DIST)/openssh-client/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man5/ssh_config.5 $(BUILD_DIST)/openssh-client/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man5
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man8/{ssh-keysign.8,ssh-pkcs11-helper.8,ssh-sk-helper.8} $(BUILD_DIST)/openssh-client/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man8
	...
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/sbin $(BUILD_DIST)/openssh-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec/sshd-keygen-wrapper $(BUILD_DIST)/openssh-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man5/{moduli.5,sshd_config.5} $(BUILD_DIST)/openssh-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man5
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man8/sshd.8 $(BUILD_DIST)/openssh-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man8
	
	# openssh.mk Prep openssh-sftp-server
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec/sftp-server $(BUILD_DIST)/openssh-sftp-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/libexec/
	cp -a $(BUILD_STAGE)/openssh/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man8/sftp-server.8 $(BUILD_DIST)/openssh-sftp-server/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man8
