...
icu4c: icu4c-setup
	...
	for stuff in $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicu*.68.2.dylib $(BUILD_BASE)/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicu*.68.2.dylib $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/*; do \
		...
		$(I_N_T) -change libicutest.68.dylib /$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicutest.68.dylib $$stuff; \
		$(I_N_T) -change libicutu.68.dylib /$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicutu.68.dylib $$stuff; \
		$(I_N_T) -change libicuuc.68.dylib /$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicuuc.68.dylib $$stuff; \
	done
endif
...
icu4c-package: icu4c-stage
	...
	mkdir -p $(BUILD_DIST)/libicu{68,-dev}/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib \
		$(BUILD_DIST)/libicu-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share \
		$(BUILD_DIST)/icu-devtools/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
	
	# icu4c.mk Prep libicu68
	cp -a $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicu*.68*.dylib $(BUILD_DIST)/libicu68/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib
	
	# icu4c.mk Prep libicu-dev
	cp -a $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/libicu{data,i18n,io,test,tu,uc}.dylib $(BUILD_DIST)/libicu-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib
	cp -a $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib/{pkgconfig,icu} $(BUILD_DIST)/libicu-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/lib
	cp -a $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/icu $(BUILD_DIST)/libicu-dev/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share
	
	# icu4c.mk Prep icu-devtools 
	cp -a $(BUILD_STAGE)/icu4c/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/{sbin,bin,share} $(BUILD_DIST)/icu-devtools/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)
	rm -f $(BUILD_DIST)/icu-devtools/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/bin/icu-config
	rm -f $(BUILD_DIST)/icu-devtools/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/man/man1/icu-config.1
	rm -rf $(BUILD_DIST)/icu-devtools/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/icu
