...
PWDARWIN_COMMIT     := e51be03e52cff72275c549504752a3d8051102d0
DEB_SYSTEM-CMDS_V   ?= $(SYSTEM-CMDS_VERSION)-4
...
system-cmds: system-cmds-setup
	...
	mkdir -p $(BUILD_STAGE)/system-cmds/{/bin,/sbin,/usr/bin,/usr/sbin,/usr/share/man/man{1,5,8}}
	...
	+	cp -a $(BUILD_WORK)/system-cmds/{arch,chpass,getconf,login,passwd}.tproj/*.1 $(BUILD_STAGE)/system-cmds/usr/share/man/man1/
	cp -a $(BUILD_WORK)/system-cmds/{getty,nologin,sysctl}.tproj/*.5 $(BUILD_STAGE)/system-cmds/usr/share/man/man5/
	cp -a $(BUILD_WORK)/system-cmds/{ac,accton,dmesg,dynamic_pager,getty,hostinfo,iostat,mkfile,nologin,pwd_mkdb,reboot,sync,sysctl,vifs,vipw,zdump,zic}.tproj/*.8 $(BUILD_STAGE)/system-cmds/usr/share/man/man8/
	$(LN) -sf reboot.8.zst $(BUILD_STAGE)/system-cmds/usr/share/man/man8/halt.8.zst
...
system-cmds-package: system-cmds-stage
	...
	$(FAKEROOT) chmod 4555 $(BUILD_DIST)/system-cmds/usr/bin/chpass
