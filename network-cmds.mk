...
network-cmds-setup: setup
	...
	cp -a $(MACOSX_SYSROOT)/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/include/nlist.h $(BUILD_WORK)/network-cmds/include
...
network-cmds: network-cmds-setup
	...
	for bin in ifconfig ip6addrctl netstat ping6 route rtsol; do \
		$(LN) -sf ../$(MEMO_SUB_PREFIX)/sbin/$$bin $(BUILD_STAGE)/network-cmds/$(MEMO_PREFIX)/sbin; \
	done
	$(LN) -sf ../$(MEMO_SUB_PREFIX)/sbin/ping6 $(BUILD_STAGE)/network-cmds/$(MEMO_PREFIX)/bin
