...
POJAVLAUNCHER_COMMIT    := f9198b4a91ce695ffa6c809d7330ff558a144a6d
POJAVLAUNCHER_VERSION   := 1.1+git20210417.$(shell echo $(POJAVLAUNCHER_COMMIT) | cut -c -7)
...
pojavlauncher: pojavlauncher-setup
	...
	cd $(BUILD_WORK)/pojavlauncher; \
		...
		cd Natives; \
			...
			/Applications/Xcode.app/Contents/Developer/usr/bin/actool Natives/Assets.xcassets --compile Natives/resources --platform iphoneos --minimum-deployment-target 12.0 --app-icon AppIcon --output-partial-info-plist /dev/null; \
