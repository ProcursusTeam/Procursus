...
libbluray: fontconfig expat libbluray-setup
	cd $(BUILD_WORK)/libbluray && ./bootstrap && CFLAGS="$(CFLAGS) -F$(BUILD_BASE)$(MEMO_PREFIX)/System/Library/Frameworks" ./configure -C \
...
libbluray-package: libbluray-stage
	...
	rm -rf $(BUILD_DIST)/libbluray{2,-dev}
	mkdir -p $(BUILD_DIST)/libbluray{2,-dev}/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	mkdir -p $(BUILD_DIST)/libbluray2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/doc
	
	# libbluray.mk Prep libbluray2
	cp -a $(BUILD_STAGE)/libbluray2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib/libbluray.8.dylib $(BUILD_DIST)/libbluray/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/lib
	cp -a $(BUILD_STAGE)/libbluray2/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/doc/libbluray $(BUILD_DIST)/libbluray/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/share/doc/libbluray
	...
	# libbluray.mk Prep libbluray-doc
