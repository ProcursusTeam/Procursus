...
gettext-localizations: setup
	mkdir -p $(BUILD_STAGE)/gettext-localizations/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share
	cp -af /$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/locale $(BUILD_STAGE)/gettext-localizations/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share
	rm -f $(BUILD_STAGE)/gettext-localizations/$(MEMO_PREFIX)$(MEMO_SUBPREFIX)/share/locale/locale.alias
else
gettext-localizations:
