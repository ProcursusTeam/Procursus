...
curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $OUT_SYSROOT/usr/include \
	https://opensource.apple.com/source/xnu/xnu-6153.61.1/libsyscall/wrappers/spawn/spawn.h
curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $OUT_SYSROOT/usr/include/mach/machine \
	https://opensource.apple.com/source/xnu/xnu-6153.81.5/osfmk/mach/machine/thread_state.h
curl --silent -Z --create-dirs -C - --remote-name-all --output-dir $OUT_SYSROOT/usr/include/bsdm \
